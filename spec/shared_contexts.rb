...
RSpec.shared_examples_for 'Page' do
  it "has top-level menu" do
    ...
    expect(page).to have_css("ul.nav li", count: 3)
  end
  ...
  it "has footer" do
    ...
    expect(page).to have_link("Common Bugs", href: '//fedoraproject.org/wiki/Common_F22_bugs')
    expect(page).to have_link("Installation Guide", href: '//docs.fedoraproject.org/en-US/Fedora/22/html/Installation_Guide')
